...
export default function DaycareCheckupBrowserPage({ rooms, showToast, onOpenCheckup }) {
  ...
  function handleExport() {
    ...
    a.href = url
    a.download = 'ตรวจสุขภาพนักเรียน-สถานรับเลี้ยงเด็กกลางวัน.csv'
                ...
                <tbody>
                  {pageRooms.map((r) => (
                    <tr key={r.id}>
                      ...
                      <td>
                        <button className="btn btn-primary btn-sm" onClick={() => onOpenCheckup(r)}>ตรวจสุขภาพ</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
