...
export default function ServiceHistoryPage({ schools, showToast, onOpenDetail }) {
  ...
  function handleExport() {
    ...
    a.href = url
    a.download = 'ประวัติการให้บริการ.csv'
      ...
      <div className="toolbar-card" style={{ marginTop: 20 }}>
        <div className="search-input-wrap" style={{ maxWidth: 890, margin: '0 auto 20px' }}>
          ...
          <input
            ...
            placeholder="ค้นหาชื่อ โรงเรียน / เขต / แขวง"
            value={search}
        ...
        {filtered.length === 0 ? (
          ...
          <>
            <ServiceHistoryTable
              schools={pageSchools}
              kind={activeTab}
              onView={(school) => onOpenDetail(school, activeTab)}
            />
