...
export default function MultiSelectField({ options, values, onChange, placeholder, disabled = false }) {
  ...
  return (
    <div style={{ position: 'relative' }} ref={rootRef}>
      ...
      <div className={`dd${open && !disabled ? ' open' : ''}`} style={{ position: 'absolute', top: 'calc(100% + 4px)', left: 0, right: 0, maxHeight: 220, overflowY: 'auto' }}>
        {options.map((opt) => (
